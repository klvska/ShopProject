...
<?php
          ...
          if (isset($_SESSION["current_user"])){
            ...
            Witaj '.$_SESSION["current_user"] . '<br>'. ' <small><a href="logout.php">wyloguj</a></small>
          </li>';
         } else {
            echo '<li class="nav-item text-center">
        ...
        <div class="col-md-12">
          ...
          <?php if (isset($_SESSION["cart_items"])) : ?>
                ...
                <li class="list-group-item">
                  <div class="row">
                    <div class="col-md-8">
                      ...
                      <?php
                      if ($quantity == 1) {
                        echo "<form style='display: inline-block' method='post' action='change_quantity.php?id=$id&action=minus'>
            ...
            echo "<form action='checkout.php' method='post'>
              <button type='submit' disabled class='btn btn-zamow'>Złóż zamówienie</button>
            </form>";
            } else{
              echo "<form action='checkout.php' method='post'>
